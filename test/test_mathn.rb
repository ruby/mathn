...
class TestMathn < Test::Unit::TestCase
  def test_power
    ...
    assert_in_out_err ['-Ilib', '-rbundler/setup', '-rmathn', '-e', 'a=Complex(0,1)**4;!a'], "", [], stderr, '[ruby-core:44170]'
    assert_in_out_err ['-Ilib', '-rbundler/setup', '-rmathn', '-e', 'a=Complex(0,1)**5;!a'], "", [], stderr, '[ruby-core:44170]'
  end
